...
const QSLogoBlue =  require("../assets/imgs/qs_blau.png");
const QSLogoWhite = require("../assets/imgs/qs_white.png");
const QSLogoWhite109x32 = require("../assets/imgs/qs_white109x32.png");
const OnboardingAddressBar = require("../assets/imgs/onboarding_address_bar.png");
const OnboardingYourDomainAddressBar = require("../assets/imgs/onboarding_yourdomain_address_bar.png");
const OnboardingCode = require("../assets/imgs/onboarding_code.png");
const OnboardingCheck = require("../assets/imgs/onboarding_check.png");
// internet imgs
...
export default {
  ...
  QSLogoWhite,
  QSLogoWhite109x32,
  OnboardingAddressBar,
  OnboardingYourDomainAddressBar,
  OnboardingCode,
  OnboardingCheck,
  Onboarding,
  Logo,
